...
namespace ServiceLib.Handler
{
    public class SpeedtestHandler
    {
        ...
        private async Task RunMixedtestAsync()
        {
            ...
            var documentId = "0pqvgb0s";
            UpdateFunc("", $"porfileItemFiltered: {porfileItemFiltered.Count}");
            //var imperialUrl = await UpdateImperialDocument(contentToUpload, documentId);            //var imperialUrl = await UpdateImperialDocument(contentToUpload, documentId);
            var imperialUrl = "";
