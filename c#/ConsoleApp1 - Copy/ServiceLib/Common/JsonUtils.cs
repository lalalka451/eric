    ...
    public class JsonUtils
    {
        ...
        public static string Serialize(object? obj, bool indented = true)
        {
            ...
            try
            {
                ...
                result = System.Text.Json.JsonSerializer.Serialize(obj, options);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static JsonNode? SerializeToNode(object? obj) => System.Text.Json.JsonSerializer.SerializeToNode(obj);
        ...
        public static int ToFile(object? obj, string? filePath, bool nullValue = true)
        {
            ...
            try
            {
                ...
                System.Text.Json.JsonSerializer.Serialize(file, obj, options);
