...
namespace ServiceLib.Handler
{
    ...
    public class ConfigHandler
    {
        ...
        public static List<ProfileItem> AddBatchServers2(Config config, string strData, string subid, bool isSub)
        {
            if (Utils.IsNullOrEmpty(strData))
            {
            ...
            var counter = 0;
            List<ProfileItem> lstAdd = AddBatchServers2(config, strData, subid, isSub, lstOriSub);


            return lstAdd;
        }

        private static List<ProfileItem> AddBatchServers2(Config config, string strData, string subid, bool isSub, List<ProfileItem> lstOriSub)
        {
            if (Utils.IsNullOrEmpty(strData))
            {
                return new List<ProfileItem>();
