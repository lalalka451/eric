...
namespace ServiceLib.ViewModels
{
    public class ProfilesViewModel : MyReactiveObject
    {
        ...
        public ProfilesViewModel(Func<EViewAction, object?, Task<bool>>? updateView)
        {
            ...
            //var selectedServers = LazyConfig.Instance.ProfileItems(_config.subIndexId, "")
            //               .Where(s => s.configType != EConfigType.Custom)
            ...
            //                   // Copy other necessary properties from ServerTestItem to ProfileItem
            //               })
            //               .ToList(); // Convert to List<ProfileItem>


            //new SpeedtestHandler(_config, Locator.Current.GetService<CoreHandler>(), selectedServers, ESpeedActionType.Mixedtest, UpdateSpeedtestHandler);
        ...
        public void RemoveDuplicateServer()
        {
