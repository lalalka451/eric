...
crsr.execute('''
            CREATE TABLE IF NOT EXISTS  HelpYourself.jobsdb2024all (
                    ...
                    search_type TEXT,
                    ApplicantCount TEXT,
                    ApplicantsWithResumePercentage TEXT,
                    ApplicantsWithCoverLetterPercentage TEXT,
                    apply TEXT,
                    mergeFrom TEXT
                );
                ''')
...
def find_job_detail(id):
    ...
    #         crsr.execute(
    #             "UPDATE jobsdb2024 SET ApplicantCount = %s, ApplicantsWithResumePercentage = %s, ApplicantsWithCoverLetterPercentage = %s WHERE job_id = %s",
