...
import os
from telegram_template import send_photo_to_telegram
...
db_handle = db_handler('douyin_image', 'media')
...
headers = {
    ...
    "Referer": "https://www.douyin.com/discover?modal_id=7417765110145355047",
            ...
            for comment in comments_data.get('comments', []):
                ...
                if image_list:
                    for image in image_list:
                        ...
                        comment_image_urls.extend(origin_url_obj.get('url_list', []))
                ...
                if sticker:
                    ...
                    if animate_url_obj.get('url_list'):
                        sticker_urls.extend(animate_url_obj.get('url_list', []))
                    elif static_url_obj.get('url_list'):
                        sticker_urls.extend(static_url_obj.get('url_list', []))
